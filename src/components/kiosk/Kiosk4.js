...
class Kiosk4 extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      showModal: false,
    ...
    return (
      ...
      <div class="leftMenu">
        ...
        <div className="footer alignCenter">
          <div className="footerIcon alignCenter"><img src="/aiims/assets/images/hospital.png" alt="" className="footerImage" /></div>
          <div className="footerIcon alignCenter"><img src="/aiims/assets/images/milk.png" alt="" className="footerImage" /></div>
          <div className="footerIcon alignCenter"><img src="/aiims/assets/images/patient.png" alt="" className="footerImage" /></div>
          <div className="footerIcon alignCenter"><img src="/aiims/assets/images/pharmacy.png" alt="" className="footerImage" /></div>
          <div className="footerIcon alignCenter"><img src="/aiims/assets/images/shop.png" alt="" className="footerImage" /></div>
        </div>
      </div>
    );
  }

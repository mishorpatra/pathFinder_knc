...
class Kiosk1 extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      showModal: false,
  ...
  color_canvas_spl = (i, canvasid, color, srcfloorL) => {
    ...
    if (color === "yellow") {
      ...
      if (frConnType === "Stairs") {
        ...
        // var img = new Image();
        // img.src = '/aiims/assets/images/downfloorConnection.png';
        // img.onload = function() {
        ...
        // img.src = '/aiims/assets/images/UpLift.png';
        // img.onload = function() {
        //   context.drawImage(img,pos_x-25,pos_y-35,50,50);
        // }
        var half_scale = scale / 2;
  ...
  handleQuickAccess = (elementName,elementFloor) => {
    console.log("clicked",elementName,elementFloor)
    let name = null;
    let val = null;
    let floor = null;
    let nodes = this.props.allNodes[0];
    let nodes_n = this.props.allNodes[0].nodes;
      for (let i = 0; i < nodes.nodes.length; i++) {
        console.log("nodes",nodes.nodes[i].name)
        if (
          elementName == nodes.nodes[i].name &&
          elementFloor == nodes.nodes[i].floor
        ) {
          name = nodes.nodes[i].name;
          floor = nodes.nodes[i].floor;
          val = nodes.nodes[i].node;
  ...
  componentDidMount() {
    ...
    try {
      ...
      this.buildingName = 'RajendraPrasadCentre';
      localStorage.setItem("buildingName", 'RajendraPrasadCentre');
    ...
    return (
            ...
            <div>
              <div className="row">
                <div className="col">
                  ...
                  >
                    <img
                      src="/aiims/assets/images/restroom.png"
                      className="img-fluid"
                     />
                  </button>
                </div>
                <div className="col">
                  ...
                  >
                    <img src="/aiims/assets/images/tap.png" className="img-fluid" />
                  </button>
                </div>
                ...
                <div className="col">
                  ...
                  >
                    <img
                      src="/aiims/assets/images/floorConnection.png"
                      className="img-fluid"
                    />
                  </button>
                </div>
              ...
              <div className="row">
                <div className="col">
                  ...
                  >
                    <img
                      src="/aiims/assets/images/exit.jpg"
                      width="25"
                      height="25"
                      className="img-fluid"
                    />
          ...
          <div>
            <div className="mt-1 canvaDiv">
              ...
              <img
                alt="map"
                id="srcImage"
                src="/aiims/assets/images/start.png"
                hidden={true}
              ></img>
              <img
                alt="map"
                id="dstImage"
                src="/aiims/assets/images/destination.png"
                hidden={true}
              ></img>
              <img
                alt="map"
                id="stairs"
                src="/aiims/assets/images/stair.png"
                hidden={true}
              ></img>
              <img
                alt="map"
                id="lift"
                src="/aiims/assets/images/lift.png"
                hidden={true}
              ></img>
      ...
      <div class="leftMenu">
        ...
        <div className="footer alignCenter">
          <div className="footerIcon alignCenter" onClick={this.handleQuickAccess.bind(this,'Counter 7 ( Online Appointment / Registration ) ','ground')}  >Counter 7</div>
          <div className="footerIcon alignCenter" onClick={this.handleQuickAccess.bind(this,'Dilation ( 116 )','first')}  >Dilation </div>
          <div className="footerIcon alignCenter" onClick={this.handleQuickAccess.bind(this,'Towards E7 and E8','ground')}  >Extention OPD E8 </div>
          {/* <div className="footerIcon alignCenter" onClick={this.handleQuickAccess.bind(this,'','ground')}  >Referection E7 </div> */}
          <div className="footerIcon alignCenter" onClick={this.handleQuickAccess.bind(this,'Chief MSSO Office ( 114 )','first')}  >Cheif MSSO </div>
          <div className="footerIcon alignCenter" onClick={this.handleQuickAccess.bind(this,'Entrance / Exit Gate','ground')}  >Exit Entry </div>
          <div className="footerIcon alignCenter" onClick={this.handleQuickAccess.bind(this,'Payment Counter','first')}  >Payment counter </div>
        </div>
      </div>
    );
  }
